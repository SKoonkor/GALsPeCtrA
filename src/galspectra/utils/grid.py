...
def build_param_grid(params, coeffs, param_names):
    """Convert flattened SSP samples into a structured grid.

    params: (N_samples, N_params). coeffs: (N_samples, N_pc). param_names: list.

    Returns (age_unique (N_age,) linear, Z_unique (N_Z,) logzsol,
